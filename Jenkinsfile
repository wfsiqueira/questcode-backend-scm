...
) 
{
    ...
    def APP_NAME = "questcode-backend-scm"
    def ENVIRONMENT
    def GIT_REPOS_URL = "https://github.com/wfsiqueira/questcode-backend-scm.git"
    def GIT_BRANCH 
    def HELM_CHART_NAME = "questcode/questcode-backend-scm"
